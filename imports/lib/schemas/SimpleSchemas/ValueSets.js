...
export let ValueSets = new Mongo.Collection('ValueSets');
...
let ValueSetSchemaR4 = new SimpleSchema({
  "resourceType" : {
    type: String,
...
let ValueSetSchema = ValueSetSchemaR4;
// ValueSets.attachSchema(ValueSetSchema);

export { ValueSetSchema, ValueSetSchemaR4 }