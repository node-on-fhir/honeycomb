...
export let MedicationAdministrations = new Mongo.Collection('MedicationAdministrations');
...
let MedicationAdministrationSchema = DomainResourceSchema.extend({
  "resourceType" : {
    type: String,
...
// MedicationAdministrations.attachSchema(MedicationAdministrationSchema);

export default { MedicationAdministration, MedicationAdministrations, MedicationAdministrationSchema };