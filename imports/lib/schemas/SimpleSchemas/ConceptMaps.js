...
export let ConceptMaps = new Mongo.Collection('ConceptMaps');
...
let ConceptMapSchema = DomainResourceSchema.extend({
  "resourceType" : {
    type: String,
...
// ConceptMaps.attachSchema(ConceptMapSchema);

export default { ConceptMap, ConceptMaps, ConceptMapSchema };