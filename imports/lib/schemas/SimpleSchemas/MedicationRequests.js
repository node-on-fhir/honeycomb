...
export let MedicationRequests = new Mongo.Collection('MedicationRequests');
...
//   if(Package['clinical:autopublish']){
//     let MedicationRequests = new Mongo.Collection('MedicationRequests');
...
let MedicationRequestSchema = new SimpleSchema({
  "resourceType" : {
    type: String,
