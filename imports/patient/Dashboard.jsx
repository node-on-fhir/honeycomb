...
export function Dashboard(props){
    ...
    let noPatientSelectedCard = <Card style={{minHeight: '200px', marginBottom: '40px'}} disabled>
    ...
    if(data.locationsCount > 0){
        ...
        if(data.selectedPatient){
            locationCard.push(<Card scrollable >
    ...
    if(data.conditionsCount > 0){
        displayNoDataCard = false;
        if(data.selectedPatient){
            conditionCard.push(<Card scrollable >
    ...
    if(data.proceduresCount > 0){
        displayNoDataCard = false;
        if(data.selectedPatient){
            procedureCard.push(<Card scrollable>
    ...
    if(data.encountersCount > 0){
        displayNoDataCard = false;
        if(data.selectedPatient){
            encounterCard.push(<Card scrollable >
    ...
    if(data.immunizationsCount > 0){
        displayNoDataCard = false;
        if(data.selectedPatient){
            immunizationCard.push(<Card scrollable >
    ...
    if(data.medicationsCount > 0){
        displayNoDataCard = false;
        if(data.selectedPatient){
            medicationCard.push(<Card scrollable >
    ...
    //     displayNoDataCard = false;
    //     if(data.selectedPatient){
    //         medicationRequestCard.push(<Card scrollable>
    ...
    if(data.medicationStatementsCount > 0){
        displayNoDataCard = false;
        if(data.selectedPatient){
            medicationStatementCard.push(<Card scrollable>
    ...
    if(data.observationsCount > 0){
        ...
        if(data.selectedPatient){
            observationCard.push(<Card scrollable >
        ...
        bloodPressureChart.push(<Card scrollable>
    ...
    if(displayNoDataCard){
      noDataCard = <Card style={{minHeight: '200px', marginBottom: '40px'}} disabled>
        <CardContent style={{fontSize: '100%', paddingBottom: '28px', paddingTop: '50px', textAlign: 'center'}}>
          <CardHeader 
    ...
    if(displayNoChartingCard){
        noChartingCard = <Card style={{minHeight: '200px', marginBottom: '40px'}} disabled>
        <CardContent style={{fontSize: '100%', paddingBottom: '28px', paddingTop: '50px', textAlign: 'center'}}>
          <CardHeader 
