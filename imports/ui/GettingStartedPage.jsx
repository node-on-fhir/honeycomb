...
function GettingStartedPage(props){
  ...
  if(!hasTitle && !hasTheme){
    if(!hasTitle){
      missingTitleElements = <Alert severity="info" sx={{marginBottom: '20px'}}>Add a settings file.</Alert>
    }
    if(!hasTheme){
      missingThemeElements = <Alert severity="info" sx={{marginBottom: '20px'}}>Add a theme and color palette.</Alert>
    }      
  ...
  return (
    <div id='GettingStartedPage' style={{"height": window.innerHeight, overflow: "scroll", paddingLeft: '40px', paddingRight: '40px', paddingBottom: '80px'}}>
      <Grid container spacing={3} justify="center" style={{paddingBottom: '80px'}}>
          ...
          <Grid item xs={6}>
            <BootstrapButton variant="contained" color="secondary" fullWidth style={{height: '147px'}}>
              <LightbulbOutlined fontSize="xl" /><CardHeader title="Getting Started Tip" subheader="Use ⌘+ and ⌘- to zoom in and out." style={{padding: '20px'}} />
            </BootstrapButton>
          </Grid>
          <Grid item xs={6}>
            {/* <Card margin={20} style={{marginBottom: '20px'}}> */}
              {/* <div style={{width: '100%', textAlign: 'center'}}> */}
              <BootstrapButton variant="contained" color="secondary" fullWidth>
          ...
          <Grid item xs={12}>
            ...
            <DynamicSpacer />
            <DynamicSpacer />
            <InvisibleCard margin={20} style={{marginBottom: '20px'}}>
