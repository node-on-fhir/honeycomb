...
/**
 * Security configuration for Clinical DICOM Viewer
 * Sets up CORS, rate limiting, and other security measures
 */

Meteor.startup(function() {
  console.log('🔒 Configuring Clinical DICOM Viewer security settings...');
  ...
  if (corsConfig.enable) {
    console.log('🌐 Setting up CORS configuration for Clinical DICOM Viewer');
  ...
  console.log('✅ Clinical DICOM Viewer security settings configured');
});